...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      // Pricing joined the left group 2026-09-14 (ud task 9b50033d) when
      // /subscribe got its real tiers — before that the only entry was the
      // footer link, which stays as-is.
      ...
      items: [
        ...
        {to: '/subscribe', label: 'Pricing', position: 'left'},
