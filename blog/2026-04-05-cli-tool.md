...
The full command reference — including file attachment, multi-context auth, and advanced query syntax — is in the [CLI Reference](/docs/cli) docs. If you are not running UnDercontrol yet, the [self-hosting guide](/docs/self-deployment) covers getting a server up with Docker in a few minutes.
