...
udctl's AI Assistant helps you work faster by understanding images and text. Snap a photo of a receipt and AI extracts the expense details. Describe a task in plain English and AI creates it for you. It's like having a smart helper that handles the tedious data entry.
...
udctl works with a wide range of AI providers:
...
You can add multiple providers and reorder them by priority. udctl uses the first available provider.
...
udctl uses a three-tier priority system:
