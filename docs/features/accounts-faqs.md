...
Use your **actual balance** (also called "current balance"). Don't include pending transactions or overdraft protection in your udctl balance.
...
No problem! udctl doesn't automatically sync with your bank, so it relies on you to keep it current. Just update when you remember - your history will still be valuable.

### Can I connect my bank accounts automatically?

Not currently. udctl requires manual balance updates. This gives you more control and privacy, but means you need to update balances yourself.
...
Yes. udctl uses industry-standard security practices:
...
### What happens to my data if I stop using udctl?
