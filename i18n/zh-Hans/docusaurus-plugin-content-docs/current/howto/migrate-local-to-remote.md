...
- 已部署并可访问的远程 UnderControl 服务器（参见 [Docker Compose 部署](/docs/self-deployment)）
...
- **其他安装方式**：参见 [CLI 下载页面](https://oatnil.com/download#cli)
...
- [CLI 命令行工具](/docs/cli)
- [Docker Compose 部署](/docs/self-deployment)
