...
如果你已经有一个正在运行的私有化实例，前往"群组"页面创建你的第一个群组。如果你还没有搭建 UnDercontrol，[私有化部署指南](/docs/self-deployment)提供了完整的配置流程——使用 Docker 可以在一小时内完成部署。

[协作功能文档](/docs/features/collaboration)涵盖了每项功能的详细说明，包括完整的权限系统，以及群组与预算、资源模块之间的交互方式。
