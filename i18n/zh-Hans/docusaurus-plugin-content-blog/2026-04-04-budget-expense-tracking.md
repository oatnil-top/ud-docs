...
如果你想开始上手，[自部署指南](/docs/self-hosting/overview) 提供了使用 Docker 搭建 UnDercontrol 的完整流程。[预算功能文档](/docs/features/budget-management) 则详细介绍了每项功能，包括预算总额的计算方式以及如何有效使用调整记录。
